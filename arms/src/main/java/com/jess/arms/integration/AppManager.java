...
public final class AppManager {
    ...
    public void onReceive(Message message) {
        switch (message.what) {
            ...
            case SHOW_SNACKBAR:
                if (message.obj == null)
                    break;
                showSnackbar((String) message.obj, message.arg1 == 0 ? false : true, message.arg2);
                break;
            case KILL_ALL:
                killAll();
                break;
     ...
     * @param isLong
     */
    public void showSnackbar(String message, boolean isLong, int type) {
        ...
        switch (type) {
            case SNACK_NORMAL:
                mView.setBackgroundColor(Color.parseColor("#07bd58"));
                break;
            case SNACK_WARING:
                mView.setBackgroundColor(Color.parseColor("#ff880e"));
                break;
            case SNACK_ERROR:
                mView.setBackgroundColor(Color.parseColor("#e93d4d"));
                break;
        }
