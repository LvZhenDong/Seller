...
public class OrderFragment extends AbstractMyBaseFragment {
    ...
    public void initData(Bundle savedInstanceState) {
        ...
        fragmentList.add(OrderListFragment.newInstance(Constant.ORDER_STATUS_RECEIPT));    //已接单
        fragmentList.add(OrderListFragment.newInstance(Constant.ORDER_STATUS_SHIPPING));   //配送中
        fragmentList.add(OrderListFragment.newInstance(Constant.ORDER_STATUS_FINISHED));   //已完成
        fragmentList.add(OrderListFragment.newInstance(Constant.ORDER_STATUS_CANCELED));   //已取消
