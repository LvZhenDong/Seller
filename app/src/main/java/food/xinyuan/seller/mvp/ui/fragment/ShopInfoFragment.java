...
public class ShopInfoFragment extends AbstractMyBaseFragment<ShopInfoPresenter> implements ShopInfoContract.View {
    ...
    @OnClick({R.id.rl_shop_bus_time, R.id.rl_shop_bus_phone, R.id.sb_operating, R.id.sb_accept_order_type,
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.rl_shop_bus_phone:    //更改联系方式
                DialogUtils.inputDialog(getActivity(), "联系电话", "请输入联系电话", InputType.TYPE_CLASS_PHONE,
                        (dialog, input) -> {
